...
#Installs WordPress server to a POD using .kube/config configuration, having ./kube/config is a pre-requisite
#kubectl apply -f https://gitlab.redblink.net/rbpublic/ps-k8s-manifests/raw/master/argocd/argocd-install.yaml
